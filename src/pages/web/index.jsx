...
class Test extends PureComponent {
  ...
  render(){
    ...
    return (
      // <div></div>
      <PageHeaderWrapper>
        <a className="ant-btn ant-btn-primary" href="./web/addarticle"><Icon type="plus" />发布</a>
        <Row gutter={16}>
          <List
            itemLayout="vertical"
            size="large"
            ...
            renderItem={item => (
              <Col span={12}>
                <div style={{backgroundColor: '#fff', borderRadius: '2px', marginBottom: '16px', paddingLeft: '24px', paddingRight: '24px'}}>
                  <List.Item
                    key={item.title}
                    extra={
                      <img
